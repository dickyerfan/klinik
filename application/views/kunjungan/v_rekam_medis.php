            ...
            <div class="col-md-6">
                <div class="card border-danger">
                    <div class="card-header bg-danger text-white">
                        Catatan Rekam Medis
                        <a href="<?= base_url('kunjungan'); ?>" class="btn btn btn-warning btn-sm float-right">Kembali</a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                foreach ($resep as $row) : ?>
                                    <tr>
                                        ...
                                        <td><?= $row['nama_obat']; ?></td>
                                        <td>
                                            <a href="<?= base_url() . 'kunjungan/hapus_resep/' . $row['id_resep'] . '/' . $row['id_berobat']; ?>" class="text-danger" onclick="return confirm('Yakin Mau di Hapus.?');">x</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
