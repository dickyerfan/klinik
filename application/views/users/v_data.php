                            ...
                            foreach ($users as $row) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url() . 'user/edit/' . $row['id']; ?>" class="btn btn-warning btn-sm">edit</a>
                                        <a href="<?= base_url() . 'user/hapus/' . $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Mau di Hapus.?');">hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
